let htmlFlashCards =
    ...
    {"Term": "< br >", "Definition": "Line break - if you want a line break without starting a new paragraph"},
    {"Term": "< a >", "Definition": "HTML link element"},
    {"Term": "href='#'", "Definition": "href is the link's destination"},
    {"Term": "< img >", "Definition": "tag for an HTML image"},
    {"Term": "src='#'", "Definition": "the location of the image to display"},
    {"Term": "alt", "Definition": "attribute specifies alternative text to be used when an image cannot be displayed"},
